...
<div class="flex flex-col gap-6 mx-8">
  <div>
    <div class="text-2xl font-semibold mb-2">Beginners Training {trainingPlan.training_label}</div>
    <div class="text-base subheading mb-2">{trainingPlan.date_text}</div>
